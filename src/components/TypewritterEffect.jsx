...
const TypewriterEffect = ({ words, className, cursorClassName }) => {
  ...
  return (
    <div
      className={cn(
        "sm:text-5xl md:text-6xl lg:text-7xl font-bold text-center",
        className
      )}
    >
      {renderWords()}
      <motion.span
        ...
        className={cn(
          "inline-block rounded-sm w-[4px] h-10 md:h-12 lg:h-14 bg-[#50a2ef]",
          cursorClassName
        )}
      ></motion.span>
    </div>
  ...
  return (
    <div className={cn("flex space-x-1 my-6", className)}>
      ...
      <motion.span
        ...
        className={cn(
          "block rounded-sm w-[4px] h-4 sm:h-6 xl:h-12 bg-[#59b5ad]",
          cursorClassName
        )}
      ></motion.span>
    </div>
